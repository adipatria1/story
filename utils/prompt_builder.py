...
from .config import get_topic_category, TOPIC_CATEGORIES
...
def build_story_prompt(
    ...
    {category_instructions.get(topic_category, category_instructions['general'])}
    ...
    if part_number == 1:
        ...
        - Present the main points or perspectives"""
